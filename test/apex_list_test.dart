...
void main() {
  group('ApexList Empty', () {
    ...
    test('empty list equality', () {
      ...
      // TODO: Check identicality once canonical empty instance is confirmed
      // expect(identical(list1, list3), isTrue);
    });
  ...
  group('ApexList Basic Operations', () {
    ...
    // TODO: Add tests for insertAll, sublist, operator+, etc.
    // TODO: Add tests involving node splits, merges, rebalancing (esp. for removeAt).
  });
}
